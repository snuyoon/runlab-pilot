...
② **5.1.3(iv) 건강 연구 동의·IRB** → ✅ **앱 내 동의 화면 `/consent` 추가**(웹 배포 완료). ⏳ **IRB 승인 증빙은 사용자가 App Review Notes에 첨부해야 함**(사용자 IRB 승인 보유 확인함).
재심사 절차: **아이콘 반영 빌드 1.0/2 재업로드 + 심사노트에 IRB 첨부 + 재제출**. 빌드 2 아카이브까지 완료, 업로드에 **ASC Issuer ID 필요**(로컬 미보관 — 사용자/브라우저에서 확보).
